...
bind_rows(
  broom.mixed::tidy(m6b,       effects = "fixed") |>
    filter(term == "transparency") |>
    mutate(model = "m6b: complete-case, without device/full trial_order adjustment",
           n_obs = nobs(m6b)),
...
cat("Final model: m_miss_adj (missingness-adjusted with slope)\n")
```
...
- **Missingness sensitivity:** The estimate was [stable / shifted by X points] when missingness predictors were included, suggesting complete-case analysis [is / may not be] fully defensible.
